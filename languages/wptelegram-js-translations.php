...
$generated_i18n_strings = array(
	...
	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:132
	...
	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:119
	...
	// Reference: js/settings/ui/basics/Instructions.tsx:74
	...
	// Reference: js/settings/ui/basics/Instructions.tsx:86
	...
	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:105
	__( 'Delay in Posting', 'wptelegram' ),

	// Reference: ../../packages/js/shared/wptelegram-ui/services/fields.ts:25
	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:98
	...
	// Reference: js/p2tg-block-editor/Files.tsx:66
	__( 'Files', 'wptelegram' ),

	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:77
	// Reference: js/settings/ui/TabbedSections.tsx:23
	// Reference: js/settings/ui/advanced/Advanced.tsx:32
	__( 'Post to Telegram', 'wptelegram' ),

	// Reference: js/p2tg-block-editor/OverrideSettings.tsx:86
	...
	// Reference: js/settings/ui/advanced/Advanced.tsx:26
	__( 'Bot API', 'wptelegram' ),

	// Reference: js/settings/ui/basics/Basics.tsx:31
	/* translators: %s button name */
	__( 'Use %s above to set automatically.', 'wptelegram' ),

	// Reference: js/settings/ui/basics/Instructions.tsx:22
	...
	// Reference: js/settings/ui/basics/Instructions.tsx:51
	__( 'Copy the token and paste into the Bot Token field below.', 'wptelegram' ),

	// Reference: js/settings/ui/basics/Instructions.tsx:55
	...
	// Reference: js/settings/ui/basics/Instructions.tsx:67
	__( 'Test your bot token below.', 'wptelegram' ),

	// Reference: js/settings/ui/basics/Instructions.tsx:68
	__( 'Activate the modules you want to use.', 'wptelegram' ),

	// Reference: js/settings/ui/basics/Instructions.tsx:69
	...
	// Reference: js/settings/ui/notify/Notify.tsx:41
	__( 'Notification Settings', 'wptelegram' ),

	// Reference: js/settings/ui/notify/WatchEmails.tsx:24
	/* translators: %s code */
	__( 'If you want to receive notification for every email, then write %s.', 'wptelegram' ),

	// Reference: js/settings/ui/notify/WatchEmails.tsx:41
	__( 'Telegram User or Group Chat ID.', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/Destination.tsx:19
	__( 'Destination', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/Destination.tsx:24
	__( 'Channel Username or Chat ID.', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/MessageKeyboard.tsx:21
	__( 'Inline Keyboard', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/MessageKeyboard.tsx:25
	__( 'Add an inline clickable button for the post URL just below the message.', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/MessageKeyboard.tsx:41
	__( 'View Post', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/MessageKeyboard.tsx:50
	...
	// Reference: js/settings/ui/p2tg/Rules.tsx:37
	__( 'When the post should be sent to Telegram.', 'wptelegram' ),

	// Reference: js/settings/ui/p2tg/Rules.tsx:47
	__( 'Which post types should be sent.', 'wptelegram' ),

	// Reference: js/settings/ui/shared/IfBotToken.tsx:15
	__( 'You must add a bot token.', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:103
	/* translators: %s: plugin name */
	__( '%s supports Cloudflare proxy for featured image upload!', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:104
	__( 'WP Telegram Pro', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:111
	__( 'Upgrade NOW', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:41
	__( 'Upgrade to Pro', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:51
	__( 'Want an absolute integration with Telegram?', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:55
	__( 'Want to add more bots?', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:59
	__( 'Need more features?', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:63
	__( 'Want to use different channels for different categories?', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:69
	/* translators: %s: plugin name */
	__( '%s supports multiple instances of Post to Telgram with different rules.', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:79
	/* translators: %s: plugin name */
	__( '%s supports ALL WooCommerce and ACF text fields.', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:85
	__( 'Want to add more buttons?', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:91
	/* translators: %s: plugin name */
	__( '%s supports delay per channel.', 'wptelegram' ),

	// Reference: js/settings/ui/shared/Upsell.tsx:97
