...
class Html2Text {
	...
	public static function convert($html, $ignore_error = false) {
		...
		$doc = self::getDocument($html, $ignore_error);

		$output = self::iterateOverNode($doc, null, false, $is_office_document);
	...
	static function iterateOverNode($node, $prevName = null, $in_pre = false, $is_office_document = false) {
		...
		if (isset($node->childNodes)) {
			...
			while($n != null) {
				...
				$text = self::iterateOverNode($n, $previousSiblingName, $in_pre || $name == 'pre', $is_office_document);
